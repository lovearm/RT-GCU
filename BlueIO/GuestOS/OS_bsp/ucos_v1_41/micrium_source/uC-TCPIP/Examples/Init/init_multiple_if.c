...
*
*           (2) Most of the time Micrium provides a device driver which can be found under the following folders:
*
...
*
*               If Micrium does not support your network device driver, you will have to write your own device
*               driver starting from the Device driver template. Before starting to write your own driver, make
*               sure that the driver is not already available.
*
*           (3) The PHY driver should be provided by Micrium and located under the following folder:
*
*                   $/Micrium/Software/uC-TCPIP/Dev/Ether/PHY/<phy part number>/net_phy_<phy part number>.h
*
*               Most of the time for MII, RMII or GMII PHY, the generic PHY works correctly. If your PHY is not
*               available and the generic is not working you will have to write you own PHY driver. Normally
*               for a single connector PHY, some minor changes to the generic driver are required.
*
*           (4) The board support package (BSP) template file should be copied to your application folder and modified
*               for your specific board. Refer to the User's Manual for more information about how to write a BSP.
*
*               However, we recommend starting with a working configuration from an example project for your network
*               device. Micrium might have some projects available only for internal usage, so if no working project are
*               found online, please ask at support@micrium.com for a BSP file example specific for your network device.
*********************************************************************************************************
*********************************************************************************************************
*/
