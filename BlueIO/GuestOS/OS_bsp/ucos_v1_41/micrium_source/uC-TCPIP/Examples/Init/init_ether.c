...
*               your device.
*
*               We recommend starting with a working configuration from an example project for your MCU. Micrium might
*               have some projects available only for internal usage, so if no working projects are found online, please
*               ask at support@micrium.com for a configuration file example.
*
*           (2) Most of the time Micrium provides an Ethernet Network device driver which can be found under the
*               following folder:
*
*                   $/Micrium/Software/uC-TCPIP/Dev/Ether/<Controller>/net_dev_<controller>.h
*
*               If Micrium does not support your network device driver, you will have to write your own device driver
*               starting from the Ethernet Device driver template. Before starting to write your own driver, make
...
*
*               However, we recommend starting with a working configuration from an example project for your MCU.
*               Micrium might have some projects available only for internal usage, so if no working project are found
*               online, please ask at support@micrium.com for a BSP file example specific for your MCU.
*********************************************************************************************************
*********************************************************************************************************
*/
