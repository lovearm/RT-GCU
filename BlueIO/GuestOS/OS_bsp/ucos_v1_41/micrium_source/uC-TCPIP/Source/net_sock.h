...
#define  NET_SOCK_ADDR_LEN_MAX                      0
    ...
    #define  NET_SOCK_PROTOCOL_NBR_MAX              1

#else
    #define  NET_SOCK_PROTOCOL_NBR_MAX              2
#endif
...
#define  NET_SOCK_PORT_NBR_RANDOM_NBR                   (NET_SOCK_NBR_SOCK + NET_SOCK_PORT_NBR_RANDOM_NBR_OFFSET)
...
#ifndef  NET_SOCK_DFLT_PORT_NBR_RANDOM_BASE
#error  "NET_SOCK_DFLT_PORT_NBR_RANDOM_BASE         not #define'd in 'net_cfg.h'                                                                    "
#error  "                                     [MUST be  >=   NET_PORT_NBR_MIN                                                                      ]"
#error  "                                     [     &&  <= ((NET_PORT_NBR_MAX + 1) - (NET_SOCK_NBR_SOCK + NET_SOCK_PORT_NBR_RANDOM_NBR_OFFSET))]"

#elif  ((DEF_CHK_VAL_MIN(NET_SOCK_DFLT_PORT_NBR_RANDOM_BASE, \
