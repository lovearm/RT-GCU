...
proc ucos_get_intr_src {periph} {
    ...
    set ps8_int_table(psu_uart_0) 59
    set ps8_int_table(psu_uart_1) 82
    set ps8_int_table(psu_ethernet_0) 54
    
    set ps5_int_table(psu_uart_0) 59
    set ps5_int_table(psu_uart_1) 82
    ...
    "microblaze" { 
        ...
        set axi_intc_driver_handle [get_drivers -filter "NAME==ucos_axiintc"]
        ucos_log_put "TRACE" "ucos_get_intr_src: Found int driver $axi_intc_driver_handle."
        ...
        if {[llength $int_source_ports] != 0} {
            ...
            if {$int_source_periph_name == "axi_intc"} {
                set axiintc_periphs [get_common_driver_ips $axi_intc_driver_handle] 
                set ix 0
