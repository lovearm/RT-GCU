...
*               TX mutex. UARTPS_WrStr will return once the entire string has been written to the device FIFO.
...
*               cpu_id       Always 0 for peripheral interrupts.
*
* Return(s)   : DEF_OK     Operation successful.
*               DEF_FAIL   Operation failed.
*
