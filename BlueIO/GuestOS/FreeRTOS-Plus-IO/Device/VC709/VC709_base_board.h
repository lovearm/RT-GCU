...
#ifndef VC709_BASE_BOARD_H
#define VC709_BASE_BOARD_H



#define UART0_BASEADDRESS        0x00000000


//	In BS system, you do not need the base_address of the UART
#define boardAVAILABLE_DEVICES_LIST												\
{																				\
	{ ( const int8_t * const ) "/UART0/", eUART_TYPE, ( void * )  UART0_BASEADDRESS}	\
}

/*******************************************************************************
 * Map the FreeRTOS+IO interface to the VC709 specific functions.
 ******************************************************************************/
...
#define boardFreeRTOS_PopulateFunctionPointers vFreeRTOS_vc709_PopulateFunctionPointers
