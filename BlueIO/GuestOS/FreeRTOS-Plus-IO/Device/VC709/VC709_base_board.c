...
#include "VC709_base_board.h"


portBASE_TYPE vFreeRTOS_vc709_PopulateFunctionPointers( const Peripheral_Types_t ePeripheralType, Peripheral_Control_t * const pxPeripheralControl )
{
